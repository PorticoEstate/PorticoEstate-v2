...
{
	public string $description = 'Create bb_booking_targetaudience and bb_booking_agegroup tables';

	public function up(): void
	{
		$this->createTable('bb_booking_targetaudience', [
			'fd' => [
				'booking_id' => ['type' => 'int', 'precision' => '4', 'nullable' => false],
				'targetaudience_id' => ['type' => 'int', 'precision' => '4', 'nullable' => false],
			],
			'pk' => ['booking_id', 'targetaudience_id'],
			'fk' => [
		...
		$this->createTable('bb_booking_agegroup', [
			'fd' => [
				'booking_id' => ['type' => 'int', 'precision' => '4', 'nullable' => false],
