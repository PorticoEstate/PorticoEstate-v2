					...
					{!isMobile && (
                        <>
                            <div className={styles.dateFilter}>
                                <div>
                                    <Label htmlFor="date-picker-input">{t('bookingfrontend.when')}</Label>
                                    <CalendarDatePicker
										...
										allowEmpty={true}
                                        aria-label={t('bookingfrontend.when')}
                                    />
                                </div>
                            </div>
                            ...
                            <div className={styles.townFilter}>
                                <Field>
                                    <Label htmlFor="location-select">{t('bookingfrontend.where')}</Label>
                                    <Select
                                        id="location-select"
                                        value={where}
                                        onChange={(e) => setWhere(e.target.value ? +e.target.value : '')}
                                        aria-label={t('bookingfrontend.where')}
                                    >
