import { Input,  Textfield } from "@digdir/designsystemet-react"
...
const MaxParticipantInput: FC<ParticipantInputProps> = ({ updateField, error, fieldValue }: ParticipantInputProps) => {
