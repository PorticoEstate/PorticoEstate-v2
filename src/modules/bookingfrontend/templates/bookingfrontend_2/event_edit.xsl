		...
		<div class="container wrapper">
			...
			<div class="row">
				<form action="" method="POST" id="event_form" name="form" class="col-md-8">
					...
					<h5 class="font-weight-bold mb-4">
						<xsl:value-of select="php:function('lang', 'Information about the event (edit)')" />
					</h5>
					<div class="form-group">
						<label class="text-uppercase">
						...
						<div class="dropdown d-inline-block">
							<button class="btn btn-secondary dropdown-toggle d-inline mr-2 btn-sm" id="audienceDropdownBtn" type="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
								<xsl:value-of select="php:function('lang', 'choose')" />
							</button>
					...
					<p data-bind="ifnot: typeApplicationSelected, visible: typeApplicationValidationMessage" class="isSelected validationMessage mt-2 mb-2">
