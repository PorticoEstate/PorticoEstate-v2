	...
	<table class="pure-table pure-table-bordered pure-table-striped pure-form">
		...
		<tbody>
			...
			<tr>
				...
				<td><input size="8" name="newsettings[cache_refresh_token]" value="{value_cache_refresh_token}"
						class="pure-u-1" /></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><input size="8" name="newsettings[sessions_timeout]" value="{value_sessions_timeout}"
						class="pure-u-1" /></td>
			</tr>

			<tr class="pure-table-odd">
				<td>{lang_Timeout_for_application_session_data_in_seconds} (default 86400 = 1 day):</td>
				<td><input size="8" name="newsettings[sessions_app_timeout]" value="{value_sessions_app_timeout}"
						class="pure-u-1" /></td>
			</tr>

			<tr>
				<td>{lang_Would_you_like_to_show_each_applications_upgrade_status}?:</td>
				<td>
			...
			<tr>
				...
				<td>
					<input name="newsettings[smtpUser]" value="{value_smtpUser}" autocomplete="off" readonly="readonly"
						onfocus="this.removeAttribute('readonly');" class="pure-u-1" />
				</td>
			</tr>
			<tr class="pure-table-odd">
				<td>{lang_Enter_your_SMTP_server_password}:</td>
				<td><input type="password" name="newsettings[smtpPassword]" value="{value_smtpPassword}"
			...
			<tr>
				...
				<td>http://<input name="newsettings[bakcground_image]" value="{value_bakcground_image}"
						class="pure-u-1" /></td>
			</tr>
			...
			<tr class="pure-table-odd">
				<td>{lang_Trusted_proxies} ({lang_comma_separated_list_of_IPs_or_CIDR}):</td>
				<td>
			...
			<tr>
				<td>{lang_How_many_days_should_entries_stay_in_the_access_log_before_they_get_deleted}? (default 90):
				</td>
				<td>
