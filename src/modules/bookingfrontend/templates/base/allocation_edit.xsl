	...
	<div id="allocation-cancel-page-content" class="margin-top-content">
		<div class="container wrapper">
			<div class="location">
				...
				<span>
					<xsl:value-of select="php:function('lang', 'Edit allocation')"/> #<xsl:value-of select="allocation/id"/>
				</span>
			</div>
			<div class="row">
				<form action="" method="POST" class="col-md-8">
					...
					<div class="form-group">
						<div>
							<label class="text-uppercase">
								<xsl:value-of select="php:function('lang', 'Recurring allocation edit')" />
							</label>
						...
						<div>
							...
							<xsl:value-of select="php:function('lang', 'Edit until')" />
						</div>
					...
					<div class="form-group">
						<label class="text-uppercase">
							<xsl:value-of select="php:function('lang', 'Equipment text')"/>
						</label>
