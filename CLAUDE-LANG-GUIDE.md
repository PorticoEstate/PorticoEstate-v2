...
example prompt:
```aiignore
I want to fix language files according to CLAUDE-LANG-GUIDE.md, use the tool as described there to add new trnaslations, lets focus on nn,en,no in the bookingfrontend module
```
