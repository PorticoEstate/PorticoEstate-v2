	...
	public function runPending(string $module, bool $debug = false): array
	{
		...
		foreach ($pending as $entry) {
			...
			try {
				...
				// Use exception mode during migrations so errors are catchable
				...
				// Always output migration errors for visibility
				echo "<br><b>MIGRATION ERROR [{$module}/{$name}]:</b> {$errorMsg}\n";
