...
class bookingfrontend_uiallocation extends booking_uiallocation
{
	...
	private
	function info_determine_edit_link($allocation)
	{
		$bouser = new UserHelper();
	...
	private
	function calculate_resource_info($resourceIds)
	{
	...
	private
	function info_format_allocation_time($from, $to)
	{
	...
	private
	function info_calculate_participant_limit($allocation, $config)
	{
