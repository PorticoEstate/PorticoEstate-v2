...
class OrganizationController 
{
    ...
    public function getSubActivityList(Request $request, Response $response, $args)
    {
        ...
        try {
            $result = $this->organizationService->getSubActivityList($id);
...
//            }
    ...
    public function addGroupLeader(Request $request, Response $response, $args)
    {   
        ...
        try {
            $result = $this->organizationService->addGroupLeader($groupId, $request->getParsedBody());
            return ResponseHelper::sendJson($response, $result);
        } catch (Exception $e) {
            return ResponseHelper::sendErrorResponse(
                ['error' => 'Error' . $e->getMessage()],
    ...
    public function deleteGroupLeader(Request $request, Response $response, $args)
    {   
        ...
        try {
            $result = $this->organizationService->deleteGroupLeader($groupId, $leaderId);
            return ResponseHelper::sendJson($response, $result);
        } catch (Exception $e) {
            return ResponseHelper::sendErrorResponse(
                ['error' => 'Error' . $e->getMessage()],
    ...
    public function updateGroupLeaders(Request $request, Response $response, $args)
    {
        $groupId = (int)$args['groupId'];
        $session = Sessions::getInstance();
        $session_id = $session->get_session_id();
        ...
        try {
            $result = $this->organizationService->updateGroupLeaders($groupId, $request->getParsedBody());
            return ResponseHelper::sendJson($response, $result);
        } catch (Exception $e) {
            return ResponseHelper::sendErrorResponse(
                ['error' => 'Error' . $e->getMessage()],
    ...
    {   
        ...
        try {
            $result = $this->organizationService->getDelegateById($id);
            return ResponseHelper::sendJson($response, $result);
        } catch (Exception $e) {
            return ResponseHelper::sendErrorResponse(
                ['error' => 'Error' . $e->getMessage()],
    ...
    {   
        ...
        try {
            $result = $this->organizationService->getGroupById($id);
            return ResponseHelper::sendJson($response, $result);
        } catch (Exception $e) {
            return ResponseHelper::sendErrorResponse(
                ['error' => 'Error' . $e->getMessage()],
    ...
    public function patchDelegate(Request $request, Response $response, $args)
    {
        ...
        if (!$this->organizationService->delegateExist($delegateId)) {
            return ResponseHelper::sendErrorResponse(
        ...
        try {
            $result = $this->organizationService->patchDelegate($delegateId, $request->getParsedBody());
            return ResponseHelper::sendJson($response, $result);
        } catch (Exception $e) {
            return ResponseHelper::sendErrorResponse(
                ['error' => 'Error' . $e->getMessage()],
    ...
    public function createDelegate(Request $request, Response $response, $args)
    {
        ...
        try {
            $result = $this->organizationService->createDelegate($id, $request->getParsedBody());
            return ResponseHelper::sendJson($response, $result);
        } catch (Exception $e) {
            return ResponseHelper::sendErrorResponse(
                ['error' => 'Error: ' . $e->getMessage()],
    ...
    public function createGroup(Request $request, Response $response, $args)
    {
        ...
        try {
            $result = $this->organizationService->createGroup($id, $request->getParsedBody());
            return ResponseHelper::sendJson($response, $result);
        } catch (Exception $e) {
            return ResponseHelper::sendErrorResponse(
                ['error' => 'Error' . $e->getMessage()],
    ...
    public function update(Request $request, Response $response, array $args): Response
    {
        try {
            ...
            return ResponseHelper::sendJson($response, [
    ...
    public function patchGroup(Request $request, Response $response, $args)
    {
        ...
        if (!$this->organizationService->existGroup($groupId)) {
            return ResponseHelper::sendErrorResponse(
        ...
        try {
            $result = $this->organizationService->patchGroup($groupId, $request->getParsedBody());
            return ResponseHelper::sendJson($response, $result);
        } catch (Exception $e) {
            return ResponseHelper::sendErrorResponse(
                ['error' => 'Error' . $e->getMessage()],
