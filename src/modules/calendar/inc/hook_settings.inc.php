...
$preferenceHelper->create_notify(
	'Notification messages for added events ',
	'notifyAdded',
	5,
	50,
...
$preferenceHelper->create_notify(
	'Notification messages for your alarms',
	'notifyAlarm',
	5,
	50,
...
$preferenceHelper->create_input_box(
	...
	'defaultlength',
	'Default length of newly created events. The length is in minutes, eg. 60 for 1 hour.',
	'',
	3
);
...
$preferenceHelper->create_select_box(
	'Intervals per day in planner view',
...
## by tb
$preferenceHelper->create_check_box(
	'Show complete description in overview',
	'show_descrpt_ovr',
...
$preferenceHelper->create_select_box(
	'Show complete description in title-tag',
	'show_descrpt_title',
	$show_descrpt_title,
...
$preferenceHelper->create_check_box(
	'Show time-line in detailed weekly view',
	'show_time_line',
