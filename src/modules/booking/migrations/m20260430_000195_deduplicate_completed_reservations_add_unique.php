...
return new class extends Migration
{
    ...
    {
        if (!$this->tableExists('bb_completed_reservation') || !$this->tableExists('bb_completed_reservation_resource')) {
            return;
        }

        // Skip dedup if unique constraint already exists (means dedup was already done)
