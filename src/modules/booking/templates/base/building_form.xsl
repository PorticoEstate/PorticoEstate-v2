		...
		<div id="tab-content">
			...
			<div id="building_form" class="booking-container">
				<div class="pure-control-group">
					...
					<input id="field_location_code_name" name="location_code_name" type="text" value="{building/location_code}" class="pure-input-3-4" >
				...
				<div class="pure-control-group">
					...
					<input id="field_building_name" name="name" type="text" value="{building/name}" class="pure-input-3-4" >
						<xsl:attribute name="data-validation">
							<xsl:text>required</xsl:text>
						</xsl:attribute>
						<xsl:attribute name="data-validation-error-msg">
				...
				<div class="pure-control-group">
					...
					<input id="field_phone" name="phone" type="text" value="{building/phone}" class="pure-input-3-4" >
					</input>
				</div>
				<div class="pure-control-group">
					...
					<input id="field_email" name="email" type="text" value="{building/email}" data-validation="email" class="pure-input-3-4" >
				...
				<div class="pure-control-group">
					...
					<input type="text" name="zip_code" id="field_zip_code" value="{building/zip_code}" class="pure-input-3-4" />
				</div>
				<div class="pure-control-group">
					<label for="field_city">
						<xsl:value-of select="php:function('lang', 'Postal City')"/>
					</label>
					<input type="text" name="city" id="field_city" value="{building/city}" class="pure-input-3-4" />
				</div>
				...
				<div class="pure-control-group">
					...
					<input id="field_tilsyn_name" name="tilsyn_name" type="text" value="{building/tilsyn_name}" class="pure-input-3-4" />
				</div>
				<div class="pure-control-group">
					<label for="field_tilsyn_phone">
						<xsl:value-of select="php:function('lang', 'Tilsynsvakt telephone')" />
					</label>
					<input id="field_tilsyn_phone" name="tilsyn_phone" type="text" value="{building/tilsyn_phone}" class="pure-input-3-4" />
				</div>
				<div class="pure-control-group">
					<label for="field_tilsyn_email">
						<xsl:value-of select="php:function('lang', 'Tilsynsvakt email')" />
					</label>
					<input id="field_tilsyn_email" name="tilsyn_email" type="text" value="{building/tilsyn_email}" class="pure-input-3-4" />
				</div>
				<div class="pure-control-group">
					<label for="field_tilsyn_name2">
						<xsl:value-of select="php:function('lang', 'Tilsynsvakt name')" />
					</label>
					<input id="field_tilsyn_name2" name="tilsyn_name2" type="text" value="{building/tilsyn_name2}" class="pure-input-3-4" />
				</div>
				<div class="pure-control-group">
					<label for="field_tilsyn_phone2">
						<xsl:value-of select="php:function('lang', 'Tilsynsvakt telephone')" />
					</label>
					<input id="field_tilsyn_phone2" name="tilsyn_phone2" type="text" value="{building/tilsyn_phone2}" class="pure-input-3-4" />
				</div>
				<div class="pure-control-group">
					<label for="field_tilsyn_email2">
						<xsl:value-of select="php:function('lang', 'Tilsynsvakt email')" />
					</label>
					<input id="field_tilsyn_email2" name="tilsyn_email2" type="text" value="{building/tilsyn_email2}" class="pure-input-3-4" />
				</div>
				<xsl:if test="not(new_form)">
					<div class="pure-control-group">
				...
				<xsl:if test="not(new_form)">
					<div class="pure-control-group">
						...
						<select id="for_deactivate_calendar" name="deactivate_calendar" class="pure-input-3-4" >
							<option value="1">
				...
				<xsl:if test="not(new_form)">
					<div class="pure-control-group">
						...
						<select id="for_deactivate_sendmessage" name="deactivate_sendmessage" class="pure-input-3-4" >
							<option value="1">
				...
				<xsl:if test="not(new_form) and building/extra=1">
					<div class="pure-control-group">
						...
						<select id="for_extra_kalendar" name="extra_kalendar" class="pure-input-3-4" >
							<option value="1">
				...
				<div class="pure-control-group">
					...
					<textarea id="field_calendar_text" name="calendar_text" type="text" class="pure-input-3-4" >
...
<!--				<div class="pure-control-group">
					...
					<div class="custom-container pure-input-3-4">
						<textarea id="field_description" name="description" type="text" class="pure-input-1" >
				...
				<div class="pure-control-group">
					...
					<div class="custom-container pure-input-3-4">
						<textarea id="field_opening_hours" name="opening_hours" type="text" class="pure-input-1" >
