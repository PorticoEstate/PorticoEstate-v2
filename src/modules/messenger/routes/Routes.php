...
$app->group('/messenger', function (RouteCollectorProxy $group) use ($messengerCsrfMiddleware)
{
	$group->group('/view', function (RouteCollectorProxy $viewGroup)
	{
		...
		$viewGroup->get('/compose-global', MessengerViewController::class . ':composeGlobal');
	...
	$group->post('/messages/global', MessengerController::class . ':storeGlobal')->add($messengerCsrfMiddleware);
